...
/***/ function(module, exports, __webpack_require__) {
	...
	var KanbanBoardContainer = function (_Component) {
	  ...
	  _createClass(KanbanBoardContainer, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var kanbanBoard = this.props.children && _react2.default.cloneElement(this.props.children, { cards: this.state.cards });
	      return kanbanBoard;
	    }
	  }]);
	...
	KanbanBoardContainer.getStores = function () {
	  return [_CardStore2.default];
	};
	KanbanBoardContainer.calculateState = function (prevState) {
	  return { cards: _CardStore2.default.getState() };
	};
	
	exports.default = _utils.Container.create(KanbanBoardContainer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // OBSOLETE
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement('img', { src: '/app/images/Mega-Runbook-Creator-Button-01.png' })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'BebasNeue' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cardDragSpec = {
	  ...
	  endDrag: function endDrag(props) {
	    _CardActionCreators2.default.persistCardDrag(props);
	  }
	};
	...
	var cardDropSpec = {
	  hover: function hover(props, monitor) {
	    ...
	    if (props.id !== draggedId) {
	      _CardActionCreators2.default.updateCardPosition(draggedId, props.id);
	    }
	  }
	};
	...
	var Card = function (_Component) {
	  ...
	  _createClass(Card, [{
	    ...
	    value: function toggleDetails() {
	      _CardActionCreators2.default.toggleCardDetails(this.props.id);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CardActionCreators = {
	  ...
	  addCard: function addCard(card) {
	    _AppDispatcher2.default.dispatchAsync(_KanbanApi2.default.addCard(card), {
	  ...
	  updateCard: function updateCard(card, draftCard) {
	    _AppDispatcher2.default.dispatchAsync(_KanbanApi2.default.updateCard(card, draftCard), {
	  ...
	  persistCardDrag: function persistCardDrag(cardProps) {
	    var card = _CardStore2.default.getCard(cardProps.id);
	    var cardIndex = _CardStore2.default.getCardIndex(cardProps.id);
	    _AppDispatcher2.default.dispatchAsync(_KanbanApi2.default.persistCardDrag(card.id, card.status, cardIndex), {
	  ...
	  toggleCardDetails: function toggleCardDetails(cardId) {
	    _AppDispatcher2.default.dispatch({ type: _constants2.default.TOGGLE_CARD_DETAILS, payload: { cardId: cardId } });
	  },
	  createDraft: function createDraft(card) {
	    _AppDispatcher2.default.dispatch({ type: _constants2.default.CREATE_DRAFT, payload: { card: card } });
	  },
	  updateDraft: function updateDraft(field, value) {
	    _AppDispatcher2.default.dispatch({ type: _constants2.default.UPDATE_DRAFT, payload: { field: field, value: value } });
	  },
	
	  updateCardStatus: (0, _utils.throttle)(function (cardId, listId) {
	    _AppDispatcher2.default.dispatch({ type: _constants2.default.UPDATE_CARD_STATUS, payload: { cardId: cardId, listId: listId } });
	  }),
	  updateCardPosition: (0, _utils.throttle)(function (cardId, afterId) {
	    _AppDispatcher2.default.dispatch({ type: _constants2.default.UPDATE_CARD_POSITION, payload: { cardId: cardId, afterId: afterId } });
	  }, 500)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CardStore = function (_ReduceStore) {
	    _inherits(CardStore, _ReduceStore);
	    ...
	    _createClass(CardStore, [{
	        ...
	        value: function getCard(id) {
	            return this._state.find(function (card) {
	                return card.id === id;
	            });
	        }
	    }, {
	        key: 'getCardIndex',
	        value: function getCardIndex(id) {
	            return this._state.findIndex(function (card) {
	                return card.id === id;
	            });
	        }
	    }, {
	        ...
	        value: function reduce(state, action) {
	            ...
	            switch (action.type) {
	                ...
	                case _constants2.default.CREATE_CARD_SUCCESS:
	                    ...
	                    return (0, _reactAddonsUpdate2.default)(this.getState(), _defineProperty({}, _cardIndex, { id: { $set: action.payload.response.id } }));
	                ...
	                case _constants2.default.TOGGLE_CARD_DETAILS:
	                    ...
	                    return (0, _reactAddonsUpdate2.default)(this.getState(), _defineProperty({}, _cardIndex, { showDetails: { $apply: function $apply(currentValue) {
	...
	exports.default = new CardStore(_AppDispatcher2.default);
