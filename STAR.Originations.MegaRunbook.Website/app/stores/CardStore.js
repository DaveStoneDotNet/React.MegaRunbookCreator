    ...
    reduce(state, action){
        ...
        switch (action.type) {
            ...
            case constants.CREATE_CARD_SUCCESS:
                ...
                return update(this.getState(), { [cardIndex]: { id: { $set: action.payload.response.id } } });
            ...
            case constants.TOGGLE_CARD_DETAILS:
                ...
                return update(this.getState(), { [cardIndex]: { showDetails: { $apply: (currentValue) => (currentValue !== false)? false : true } } });
